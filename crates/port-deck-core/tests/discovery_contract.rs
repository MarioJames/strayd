...
fn derives_useful_names_instead_of_home_and_binary_directories() {
    let cases = [
        (
            ...
            "/Users/test-user",
            "fixture-agent",
            "/Users/test-user/.local/share/fixture-agent/versions/v1.0.0/fixture-agent --daemon-runner",
            None,
        ),
        (
            HostPlatform::MacOs,
            "/Users/test-user/",
            "fixture-agent",
            "/Users/test-user/.local/bin/fixture-agent proxy --port 9792",
            None,
        ),
        (
            HostPlatform::Linux,
        ...
        (
            ...
            r"C:\Users\mocha",
            "fixture-agent.exe",
            "fixture-agent.exe proxy --port 9792",
            None,
        ),
        (
            HostPlatform::MacOs,
            "/Users/test-user/.fixture/runtime/fixture-project/bin",
            "node",
            "node server.js",
        ...
        (
            ...
            "测试播放器",
            "/Applications/测试播放器.app/Contents/MacOS/测试播放器",
            Some("测试播放器"),
        ),
        (
            HostPlatform::MacOs,
            "/Users/test-user/.local/bin",
            "fixture-agent",
            "fixture-agent proxy --port 9792",
            None,
        ),
