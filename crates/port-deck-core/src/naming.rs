...
mod tests {
    ...
    fn resolves_applications_native_binaries_and_interpreter_entries() {
        ...
        let cases: &[Case<'_>] = &[
            (
                "fixture-agent",
                Some("/Users/test-user/.local/bin/fixture-agent"),
                &["fixture-agent", "proxy", "--port", "9792"],
                None,
                "fixture-agent",
            ),
            (
                "fixture-agent",
                Some("/Users/test-user/.local/share/fixture-agent/versions/v1.0.0/fixture-agent"),
                &["fixture-agent", "--daemon-runner"],
                Some("unrelated"),
                "fixture-agent",
            ),
            (
            ...
            (
                "测试播放器",
                Some("/Applications/测试播放器.app/Contents/MacOS/测试播放器"),
                &[],
                Some("mocha"),
                "测试播放器",
            ),
            (
                "Electron Helper",
                Some(
                    "/Applications/Strayd Test Desk.app/Contents/Frameworks/Test Helper.app/Contents/MacOS/Test Helper",
                ),
                &[],
                None,
                "Strayd Test Desk",
